...
1. [Bayesian Approach to Deep Learning](#bayesian-approach-to-deep-learning)
1. [Sim2Real and transfer learning](#sim2real-and-transfer-learning)
1. [Recurrent Neural Networks](#recurrent-neural-networks)
1. [Attention, Transformers](#attention-transformers)
1. [General Deep Learning, and RL](#general-deep-learning-ml-and-rl)
1. [Data Augmentation](#data-augmentation)
1. [Other Interesting Papers in ML](#other-interesting-papers-and-blog-posts)
1. [Force transduction, and mechanobiology](#force-transduction-and-mechanobiology)
---
...
* [ ] GraphSAGE: Inductive Representation Learning on Large Graphs [[website](http://snap.stanford.edu/graphsage/)] [[paper](https://arxiv.org/abs/1706.02216)] (__graph embedding__)
* [ ] tutorials (by B. Knyazev) [[GNN introduction](https://medium.com/@BorisAKnyazev/tutorial-on-graph-neural-networks-for-computer-vision-and-beyond-part-1-3d9fada3b80d)][[spectral GCN tutorial](https://towardsdatascience.com/spectral-graph-convolution-explained-and-implemented-step-by-step-2e495b57f801)][[spectral GCN application paper](https://arxiv.org/abs/1811.09595)]
...
* _also see_ ["Attention, Transformers"](#attention-transformers), and ["RNN"](#recurrent-neural-networks)sections.
...
* [ ] Assessing the Ability of LSTMs to Learn Syntax-Sensitive Dependencies [[paper](https://arxiv.org/abs/1611.01368)] (*measuring compositional learning*)
...
* Attention and Augmented Recurrent Neural Networks (go to [RNN section](#recurrent-neural-networks))
